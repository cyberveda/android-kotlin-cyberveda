...
class SuccessHandling {
    ...
    companion object {
        ...
        const val RESPONSE_MUST_BECOME_CODINGWITHMITCH_MEMBER =
            "You must become a member on Codingwithmitch.com to access the API. Visit https://ashishkharche.com/enroll/"
        ...
        const val SUCCESS_ABOUT_CREATED = "created"
        const val SUCCESS_ABOUT_DELETED = "deleted"
