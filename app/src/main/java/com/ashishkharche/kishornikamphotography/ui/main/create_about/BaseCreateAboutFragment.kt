...
//
//
//abstract class BaseCreateAboutFragment : DaggerFragment() {
//
...
//
//    lateinit var viewModel: CreateAboutViewModel
//
//    @Inject
...
//            ViewModelProvider(this, providerFactory).get(CreateAboutViewModel::class.java)
